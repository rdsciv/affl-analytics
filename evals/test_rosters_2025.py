...
def main():
    ...
    for y in range(2014,2018):
        ...
        if n: fail(f"{y} has {n} roster weeks — ESPN has none")
    ...
    lines=["# 2025 weekly rosters","", "CHI-32 / AFFL-012. `fact_roster_week` 2018–2025. Pre-2018 unavailable.","",
    ...
    print("PASS"); print("CHI-32: 2025 lineups present; 2014-2017 unavailable"); return 0
