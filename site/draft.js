...
(async function () {
  ...
  const S = { q: '', limit: 60, view: 'table', pos: 'ALL' };
  let heatMode = 'picks';
  ...
  async function pick(y) {
    ...
    renderKPIs(); renderSpend(); renderValue(); renderLab(); renderOverview(); renderRecap(); renderPosPPD(); renderAuctionDNA(); renderCustody(); renderW1(); renderAge(); renderBoard(); renderFgNav(); renderGuide();
  }
